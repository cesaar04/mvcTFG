...
class Actividades extends Controlador {
    ...
    public function enviarCorreo() {
        ...
        try {
            ...
            $cuerpo .= "<strong>Telefono:</strong>". $_SESSION['telefono'] ."<br>";
            $cuerpo .= "<strong>Direccion:</strong> ". $_SESSION['direccion'] ."<br>";
            $cuerpo .= "<strong>Fecha de Nacimiento:</strong>". $_SESSION['fechaNacimiento']. "<br>";
            $cuerpo .= "<strong>Rama:</strong>". $_SESSION['rama']. "<br>";
            $cuerpo .= "</p>";
            $cuerpo .= "<h3>Caracteristicas de la actividad:</h3>";
            ...
            $cuerpo .= "<strong>Descripcion:</strong> " .  $_SESSION['descripcion'] . "<br>";
            $cuerpo .= "</p>";
            $mail->isHTML(true);
            $mail->Body = $cuerpo;
